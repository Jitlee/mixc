<template>
	<el-tabs style="width: 100%">
		<el-tab-pane label="店铺信息" name="info">
			<el-form :model="formData" :rules="formRules" ref="formData" label-width="100px">
				<div style="position: relative">
					...
					<el-form-item label="商铺名称" prop="shopName" class="el-form-item-left">
						<el-input v-model="formData.shopName" auto-complete="off" placeholder="请输入商铺名称" :maxlength="20"></el-input>
					</el-form-item>
					<el-form-item label="英文名称" prop="shopEnName" class="el-form-item-left">
						<el-input v-model="formData.shopEnName" auto-complete="off" placeholder="请输入商铺英文名称" :maxlength="30"></el-input>
					</el-form-item>
					<el-form-item label="搜索索引" prop="shopEnName" class="el-form-item-left">
						<el-input v-model="formData.shopIndex" auto-complete="off" placeholder="请输入商铺索引(字母A-Z|数字0-9)" :maxlength="1"></el-input>
					</el-form-item>
				</div>
				<hr /> 
				<div style="position: relative;height: 160px;">
					<mixc-upload :clientId="formData.clientId" :type="9" v-model="formData.shopImage" :path="shopImagePath" title="单击上传商铺图片"></mixc-upload>
					<el-form-item label="商铺类型" prop="shopType" class="el-form-item-left">
					...
					<el-form-item label="商铺描述" class="el-form-item-left">
						<el-input type="textarea" v-model="formData.shopDesc" placeholder="请输入商铺描述" :maxlength="100"></el-input>
					</el-form-item>
				</div>
				<hr /> 
				<div style="position: relative;height: 160px;">
				...
				<div style="position: relative">
					...
					<el-form-item label="商铺电话" class="el-form-item-left" style="position: relative">
						<el-input v-model="formData.shopTel" auto-complete="off" placeholder="请输入商铺电话" :maxlength="20"></el-input>
					</el-form-item>
					<el-form-item label="商铺网址" class="el-form-item-left">
						<el-input v-model="formData.shopUrl" type="url" auto-complete="off" placeholder="请输入商铺网址 http://" :maxlength="100"></el-input>
					</el-form-item>
				...
				<el-form-item label="商铺简介">
					<el-input type="textarea" v-model="formData.shopIntroduction" placeholder="请输入商铺简介" :maxlength="400"></el-input>
				</el-form-item>
				<el-form-item>
	    ...
	    <el-tab-pane label="商铺相册" name="album" :disabled="shopId == 0">
